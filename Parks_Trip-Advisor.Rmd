...
```{r dataTitle}
  ...
  removeWords <- c("granite","island","national","park","flinders","ranges","kangaroo","breakaways","chase","victor","harbor","harbour","morialta","adelaide","mt","mount","lofty","coober","pedy","remarkable","rocks","admirals","arch","waterfall","gully","ki","fur","wilpena","pound")
  ...
  activities <- c("walk","run","cycle","drive","camp","nature","wildlife")
...
Using the tidytext package [@R-tidytext], the text within the character fields `Title` and `Review` were analysed. Figure \@ref(fig:title) shows the ten most common positive, negative and neutral words given in titles. Figure \@ref(fig:review) shows the same for reviews.

The following words were reclassified as neutral from negative sentiment as they were overwhelmingly not used in a negative manner: `r vec_to_sentence(sort(fixSentiment),";")`.

The following words were removed from the analysis as they refer to park names or features and therefore occur frequently: `r vec_to_sentence(sort(removeWords),";")`.

Some words were also replaced with a synonym (Table \@ref(tab:changeWords)).
